...
class Blockchain(object):
    def __init__(self):
        ...
        self.nodes = set() #used set for ensuring uniqueness of the node
    ...
    def register_node(self, address):
        ...
        self.nodes.add(parsed_url.netloc) #adds the location

    #consensus algorithm, our rule is that the longest valid chain is authoritative :)
    ...
    def resolve_conflicts(self):
        ...
        #look for chain longer than ours
        ...
        for node in neighbours:
            ...
            if response.status_code == 200:
                ...
                if length > max_length and self.valid_chain(chain):
                    max_length = length
                    new_chain = chain
        #replace our chain if we discovered a new, valid chian longer than ours
        if new_chain:
